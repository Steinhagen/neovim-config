...
vim.o.showtabline = 0 -- Hide tabs (0), Always show tabs (2) (default: 1)
...
vim.o.autoread = true -- Reload files changed on disk via filesystem watchers (Neovim 0.13)
...
vim.g.c_syntax_for_h = 1 -- Detect .h header files as C files
